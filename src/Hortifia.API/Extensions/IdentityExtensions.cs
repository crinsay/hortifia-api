...
public static class IdentityApiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder MapHortifiaIdentityApi<TUser>(this IEndpointRouteBuilder endpoints)
        where TUser : User, new()
    {
            ...
            ([FromBody] HortifiaRegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            {
                throw new NotSupportedException($"{nameof(MapHortifiaIdentityApi)} requires a user store with email support.");
            }
        ...
        .Add(endpointBuilder =>
        {
            ...
            confirmEmailEndpointName = $"{nameof(MapHortifiaIdentityApi)}-{finalPattern}";
